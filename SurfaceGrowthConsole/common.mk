...
SRCDIR     ?= ~/CUDA/SurfaceGrowthConsole/
ROOTDIR    ?= /usr/local/NVIDIA_GPU_Computing_SDK/C
ROOTBINDIR ?= $(ROOTDIR)/bin
BINDIR     ?= ~/CUDA/SurfaceGrowthConsole
ROOTOBJDIR ?= obj
LIBDIR     := $(ROOTDIR)/lib
COMMONDIR  := /usr/local/NVIDIA_GPU_Computing_SDK/C/common
SHAREDDIR  := /usr/local/NVIDIA_GPU_Computing_SDK/shared
...
$(OBJDIR)/%.cpp.o : $(SRCDIR)%.cpp $(C_DEPS) $(SRCDIR)%.h
	$(VERBOSE)$(CXX) $(CXXFLAGS) -o $@ -c $<

#SurfaceGrowth.cpp.o: SurfaceGrowth.cpp ComputeDefs.h SurfaceGrowth.h SurfaceGrowthProto.h
#	$(CXX) $(CXXFLAGS) -o $@ -c $<
